...
<p>
项目简介：在公司主要负责swift项目架构。swiftUI实现技术开发App。主要作品AI录音笔。只有实现了项目架构和UI。同时参与了uniapp、微信小程序、Vue端的项目开发。同时也架构了flutter鸿蒙项目架构。项目因竞标原因公司放弃该项目。在此期间对蓝牙通信、NFC通信、MQTT等技术有所的涉及。
<p> 

<h4>重庆优擎科技有限公司（2022-07 至 2025-07）</h4> 
<p>
项目简介：重庆优擎科技有限公司科技有限公司主要是从事音视频监控软件的开发和MDVR研发。在职期间对FFmpeg、视频编解码、语音对讲、ijkplayer、VLC等地三方播放器有深入理解和研究。对tutk和MQTT的SDK库有集成经验,代表作品《vantrue》和《VIOFO》。
<p> 
...
<p>
项目简介：公司的产品是音视频相关的。代表产品有《爱字幕》、《卡点》、《拼图鸭》等产品。在公司期间对内存优化、编程规范、MVVM设计模型有新的认识和理解
<p>

<h4>重庆金刚清泓科技有限公司（2019-01 至2020-11）</h4> 
<p>
项目简介：重庆金刚清泓科技有限公司的产品是围绕着个人车辆研发的一款出行平台。依托OBD硬件提供的GPS数据可以看到车辆的行车轨迹、设置电子围栏、寻车等功能。还有就是商场功能。可以通过商场购买和车相关的产品。代表作品《金刚车宝》
<p>

<h4>重庆天行者有限科技公司（2017-01 至2019-11）</h4> 
<p>
项目简介：重庆天行者科技有限公司是国泰旗下的分公司。公司是从事出行和出租车相关业务。在职期间公司开研发的是国泰出行平台。主要有乘客端和司机端。主要技术点是环信和云信相关技术。地图行车轨迹、路线、和费用先关的技术。同时集成微信支付、支付宝支付、云闪付等SDK。代表作品《国泰出行》乘客端和司机端。
<p>
