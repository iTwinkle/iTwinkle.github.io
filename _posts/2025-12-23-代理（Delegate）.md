...
### 代理（Delegate）
<img src="/images/posts/代理（Delegate）/代理（Delegate）2.jpg" > 
一、什么是代理（Delegate）
...
```
<img src="/images/posts/代理（Delegate）/代理（Delegate）1.jpg" > 
⚠️ 注意：
	•	weak：避免循环引用。
...
<img src="/images/posts/代理（Delegate）/代理（Delegate）3.jpg" > 
